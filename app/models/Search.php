...
class Search{
	...
	public static function Foodtype($fooddata){
		...
		//find foodid when user search foodname 
	...
	public static function Typefood($type){
		...
		//find foodid when user search type 
	...
	public static function Calfood($cal){
		...
		//find foodid when user search calories 
	...
	public static function Sportcal($sportdata){
		...
		return $output;
			...
			//find spordid when user search sportname 
	public static function searchsportforuser($sportname){
		...
		return $output;
			...
			//find foodid when user save favorite food
