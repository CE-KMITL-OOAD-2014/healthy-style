@extends ('theme')
@section('title')
<title>เพิ่มรายการโปรดอาหาร</title>
@stop
@section('body')
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="page-header">
                <h1>ค้นหาอาหารเพื่อเพิ่มรายการโปรดอาหาร</h1>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
           <form action="{{url('/likefood')}}" method="get"> 
                <div class="controls">
                ...
                <form action="{{url('/likefood')}}" method="post"> 
                        ...
                        <tbody> 
                         @for ($i=0; $i <count($searchFoodname) ; $i++)
                            <tr>
                                ...
                                <td><button type="submit" name="savefood" class="btn btn-success btn-block btn-lg" value="{{$foodid[$i]}}"} >บันทึก</button></td>
                            </form>
